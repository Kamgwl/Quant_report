...
const totals = useMemo(() => {
  ...
  return { totalFund, aprPnL, mayPnL, junPnL, q1PnL, q1ROI, annROI, annPnL,
    julPnL, augPnL, sepPnL, q2PnL, q2ROI, fyPnL, fyROI, winners, losers, count };
                    ...
                    color={totals.fyPnL>= 0 ? POS : NEG} />
                            <StatCard label="April P&L" value={fmtSign(totals.aprPnL)} sub={fmtROI(totals.totalFund > 0 ? totals.aprPnL /
                                ...
                                <StatCard label="May P&L" value={fmtSign(totals.mayPnL)} sub={fmtROI(totals.totalFund > 0 ? totals.mayPnL /
                                    ...
                                    <StatCard label="July P&L" value={fmtSign(totals.julPnL)} sub={fmtROI(totals.totalFund > 0 ? totals.julPnL
                                        / (totals.totalFund * 1e7) : 0)} color={totals.julPnL>= 0 ? POS : NEG} />
                                        <StatCard label="Winners / Losers" value={`${totals.winners} /
                                            ${totals.losers}`} sub={`${totals.count} total accounts`} color="#a78bfa" />
            </div>
            )}
        </div>
